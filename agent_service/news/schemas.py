...
class NewsAgentInputGuardrail(BaseModel):
    result: str = Field(description="검증 분류 결과 [specific_time_error, specific_keyword_error, verified_user_input]")
    answer: str = Field(description="사용자 질문에 대한 평가내용 그리고 사용자가 올바른 요청을 할 수 있도록 가이드라인을 제공합니다.")
